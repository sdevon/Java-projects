...
public class MFQ {
	...
	public void outputHeader() {
		System.out.println("Event\tSystemTime\tPID\tCPUTimeNeeded\tTotalTimeInSystem\tLowestLevelQueue");
		pw.println("Event\tSystem Time\tPID\tCPUTimeNeeded\tTotalTimeInSystem\tLovestLevelQueue\n");
	}
	...
	public void outStats() {
		...
		pw.println("       STATISTICS         ");
                pw.println("--------------------------");
		pw.println("Total number of jobs: " + String.valueOf(total_number_of_jobs));
		pw.println("Total time of all jobs in the system: " + String.valueOf(total_time_of_all_jobs_in_system) );
		...
		pw.println("Total CPU idle time: " + String.valueOf(cpu_idle) );
	} 
	/**
	 * Runs the simulation
	 */
		...
		if (!queueOfJobs.isEmpty()) {
			...
			for (int SystemTime = 0; SystemTime<156; SystemTime++) {
				...
				if (cpu_stat.get_remaining_time() == 1) {
					...
					pw.println("Departure  " + SystemTime + "\t" +"        "+ String.valueOf(cpu_stat.getPID()) + "\t\t"+"            " + String.valueOf(time) + "\t"+"                     " + String.valueOf(cpu_stat.getLevel()));
